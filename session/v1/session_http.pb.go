...
const OperationSessionCreateSession = "/api.session.v1.Session/CreateSession"
const OperationSessionDeleteSession = "/api.session.v1.Session/DeleteSession"
const OperationSessionGCSession = "/api.session.v1.Session/GCSession"
const OperationSessionGetSession = "/api.session.v1.Session/GetSession"
const OperationSessionUpdateSession = "/api.session.v1.Session/UpdateSession"
...
func RegisterSessionHTTPServer(s *http.Server, srv SessionHTTPServer) {
	r := s.Route("/")
	r.POST("/api/v1/session/create", _Session_CreateSession0_HTTP_Handler(srv))
	r.POST("/api/v1/session/update", _Session_UpdateSession0_HTTP_Handler(srv))
	r.POST("/api/v1/session/delete", _Session_DeleteSession0_HTTP_Handler(srv))
	r.POST("/api/v1/session/get", _Session_GetSession0_HTTP_Handler(srv))
	r.POST("/api/v1/session/gc", _Session_GCSession0_HTTP_Handler(srv))
}
...
func _Session_UpdateSession0_HTTP_Handler(srv SessionHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UpdateSessionRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationSessionUpdateSession)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Session_DeleteSession0_HTTP_Handler(srv SessionHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DeleteSessionRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationSessionDeleteSession)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Session_GCSession0_HTTP_Handler(srv SessionHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GCSessionRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationSessionGCSession)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *SessionHTTPClientImpl) DeleteSession(ctx context.Context, in *DeleteSessionRequest, opts ...http.CallOption) (*DeleteSessionReply, error) {
	var out DeleteSessionReply
	pattern := "/api/v1/session/delete"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationSessionDeleteSession))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *SessionHTTPClientImpl) GCSession(ctx context.Context, in *GCSessionRequest, opts ...http.CallOption) (*GCSessionReply, error) {
	var out GCSessionReply
	pattern := "/api/v1/session/gc"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationSessionGCSession))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *SessionHTTPClientImpl) GetSession(ctx context.Context, in *GetSessionRequest, opts ...http.CallOption) (*GetSessionReply, error) {
...
func (c *SessionHTTPClientImpl) UpdateSession(ctx context.Context, in *UpdateSessionRequest, opts ...http.CallOption) (*UpdateSessionReply, error) {
	var out UpdateSessionReply
	pattern := "/api/v1/session/update"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationSessionUpdateSession))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
